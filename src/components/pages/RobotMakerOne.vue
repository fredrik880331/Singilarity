      ...
      <div class="col-md-8 ">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <div class="pageIntro">RobotMakerOne är en AI-plattform som Singilarity tagit fram för att kunna utveckla nästa generation av robotar.</div>
            <p>Inom robotiken har det skett att paradigmskifte de senaste 10 åren. Robotar har gått från att enbart kunna använda sig av 2D teknik och simpla distans sensorer. Till att ta in hela punktmoln av sin omgivning i realtid. Detta har gett upphov till en ny generation av mer avancerade robotar. Av de robotar som idag använder sig av denna nya teknik så är självkörande bilar de som fått störst genomslagskraft hos allmänheten. Det är dock så att detta teknikskifte har potentialen för så mycket mer och kan vara det som till slut öppnar dörren till verkligt autonoma robotar.</p>
